...
**What's new**
With version 1.1.0 export Customer Billing Email and Phone along with the other information.

**[Woocommerce Export Orders](https://imaginate-solutions.com/downloads/woocommerce-export-orders/)** enables store managers to export the itemized list of the products for all the orders.
Order status columns has been added since version 1.0.0.

A new semantic UI look has been added since version 1.0.0 to improve the user experience of the reports 
...
Moreover since version 1.0.0 we have removed the usage of flash which we were previuosly using since flash is going to be discontinued in the near future.

For any suggestions and customizations please drop in a mail at info@imaginate-solutions.com

Pro version of the plugin can be found at **[WooCommerce Export Orders Pro](https://imaginate-solutions.com/downloads/woocommerce-export-orders/)**

Some of the other **Pro Plugins**

1. **[WooCommerce Addon Uploads Pro](https://imaginate-solutions.com/downloads/woocommerce-addon-uploads/)**

2. **[WooCommerce Variation Reports](https://imaginate-solutions.com/downloads/woocommerce-variations-reports/)**
...
1. Export Order Dashboard with new Semantic UI look with Customer Email and Phone
2. Export Order Buttons no longer using flash
